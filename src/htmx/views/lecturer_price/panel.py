...
def panel(request: HttpRequest, webinar_pk: int, mode: str):
    """CRM lecturer price card"""
    result_template_path = "htmx/lecturer_price/panel.html"
    form_template_path = "htmx/lecturer_price/panel_form.html"
    ...
    def get_result():
        ...
        expected_income_display = f"{expected_income_sign} {abs(expected_income):,}"
